    ...
    return (
        <div className="force-cursor-visible w-screen h-screen relative overflow-hidden" style={{ backgroundColor: bgColor }}>
            ...
            <div className="absolute top-6 left-6 z-50 flex flex-col gap-3">
                <Link href="/" className="flex items-center justify-center gap-2 bg-black/50 backdrop-blur border border-[#00ff41]/50 text-[#00ff41] px-4 py-2 rounded font-mono text-sm hover:bg-[#00ff41]/10 hover:shadow-[0_0_15px_rgba(0,255,65,0.4)] transition-all cursor-pointer w-48">
                    ← Disconnect (Core)
                </Link>
